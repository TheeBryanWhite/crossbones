<?php
/*
	Reveal IDs (Modified by Lauchlan)
...
class Lauchlan_Core_Reveal_IDs {
	...
	function lauchlanCoreRevealIds() {
		$this->__construct();
	}
	...
	public function add_css() {
		echo "\n" . '<style type="text/css">
	table.widefat th.column-vtl_id {
		width: 70px;
	}

	table.widefat td.column-vtl_id {
		word-wrap: normal;
	}
	</style>' . "\n";
	}
	...
	public function column_return_value($value, $column_name, $id) {
		if ($column_name == 'vtl_id') $value = $id;
		return $value;
	}
